...
export const MESSAGES = {
  ...
  SPEC_CREATED: 'Specification file created',
  SPEC_ALREADY_EXISTS: 'Specification file already exists',
  EMPTY_SPEC_FOUND: 'Specification file is empty',
  NO_SPEC_FOUND: 'No specification file found',
  NO_SPEC_PATH_FOUND: 'Missing required argument filePath',
  INVALID_SPECFILE_EXTENSION: 'Specification file should be a Yaml file',
  ERROR_READING_SPEC: 'Error reading specification file',
  NEST_CLI_NOT_FOUND: 'nest-cli.json not found or invalid. Using default spec file path.',
  NO_VALID_SERVICES_PROVIDED:'No valid services found to generate Docker files',
  DOCKER_FILES_GENERATED: (name: string) => `Generated Docker files for ${name}`,
  DOCKER_FILES_GENERATION_ERROR: (name: string) => `Failed to generate Docker files for ${name}`,
